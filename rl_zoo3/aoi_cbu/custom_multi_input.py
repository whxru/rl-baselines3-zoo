...
class CustomMultiInputPolicy(ActorCriticPolicy):
    ...
    def __init__(
        ...
        features_extractor_class: str = 'dyna',
        ...
        super().__init__(
            ...
            use_expln,
            squash_output,
            DynamicPoIFeatureExtractor if features_extractor_class == 'dyna' else SimplifiedWeightedAoIFeatureExtractor,
...
class CustomMultiInputDQNPolicy(DQNPolicy):
    """
